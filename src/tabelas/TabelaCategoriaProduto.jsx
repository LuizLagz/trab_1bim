...
export default function TabelaCategoriaProduto(props){
                ...
                <tbody>          
                    {props.listaCategorias.map((categoria, index)=> {
                        return (<tr key={index}>
                            ...
                            <td><Button variant="danger" onClick={()=>{excluirCategoria(categoria)}}>
                                ...
                                <Button variant="warning" onClick={()=>{alterarCategoria(categoria)}}>    
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
